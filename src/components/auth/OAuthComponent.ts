...
export class OAuthComponent {
  private static readonly GOOGLE_OAUTH_URL = "https://localhost:3333/v1/auth/google";
  private static readonly FORTYTWO_OAUTH_URL = "https://localhost:3333/v1/auth/42";
