  ...
  private createFriendItemHTML(friend: Friend): string {
    ...
    return `
      <div class="friend-item ${opacityClass}" data-friend-id="${friend.id}" data-relation-id="${friend.relationId}">
        <div class="friend-item-avatar ${avatarClass} cursor-pointer" data-route="/info/${friend.id}" ${avatarStyle}>
        ...
        <div class="friend-item-info">
          ...
          <div class="friend-item-username cursor-pointer" data-route="/info/${friend.id}">${
